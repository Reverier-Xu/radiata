...
mod tests {
  ...
  const TRANSACTION: &str = "txn-0123456789abcdefghijk";
  const FORGOTTEN_TRANSACTION: &str = "txn-111111111111111111111";
  use crate::{
  ...
  fn identity_records_pending_record_rejects_malformed_fields() {
    ...
    for bytes in [
      ...
      wire_bytes(PURPOSE, "txn-!12345678abcdefghijk", vec![1], operations()),
