...
use super::{CborLimits, FeatureTag, MAX_BODY_BYTES, ProtocolTag, QualifiedTag, encode_canonical};
...
const DEFINITION_LIMITS: CborLimits = CborLimits::new(16, 1_024, MAX_BODY_BYTES);
